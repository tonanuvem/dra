          ...
          <div className="border border-gray-200 rounded-lg overflow-hidden">
            ...
            {changePasswordMode && (
              <div className="px-3 pb-3 pt-3 border-t border-gray-100 bg-gray-50">
                ...
                <p className="mt-1.5 text-xs text-gray-400">Deixe em branco para manter a senha atual.</p>
              </div>
            )}
          </div>
          ...
          {credentials ? (
            <div className="space-y-4">
              ...
              <div className="bg-gray-900 rounded-lg p-4 space-y-3">
                <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Credenciais de acesso</p>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-lg font-mono font-bold text-yellow-400 tracking-widest">{credentials.password}</p>
                </div>
              </div>
              <button
            ...
            <>
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-400">O usuário poderá alterar a senha após o primeiro login.</p>
              </div>
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Gerenciamento de usuários e acessos</p>
        </div>
      </div>
      <UsersTab />
    </div>
